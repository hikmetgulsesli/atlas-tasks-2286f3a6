...
export type EmptyStateActionId = "start-game-1" | "resume-2" | "open-settings-3" | "dashboard-1" | "create-edit-2" | "detail-3" | "insights-4" | "settings-5" | "error-state-6" | "empty-state-7";

export interface EmptyStateProps {
  actions?: Partial<Record<EmptyStateActionId, () => void>>;
}
...
export function EmptyState({ actions }: EmptyStateProps) {
  return (
    <>
      <header>
          <div><div className="meta">Atlas Tasks</div><h1>Empty State</h1><p>No-data state that guides the user to the first action.</p></div>
